BZFlag Server Plugin: verticalVelocityFlag
================================================================================
...
verticalVelocityFlag directory to a new name, and then manually replace verticalVelocityFlag
...
This plugin takes no optional arguments, so load it with:
  -loadplugin verticalVelocityFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin verticalVelocityFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin verticalVelocityFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin verticalVelocityFlag,<configfilename>
For example:
  -loadplugin verticalVelocityFlag,/path/to/my/sampleplugin.cfg
